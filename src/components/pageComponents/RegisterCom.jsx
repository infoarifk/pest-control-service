...
const RegisterCom = () => {
    ...
    return (
        ...
        <div className="max-w-[500px] mx-auto px-5">
            ...
            <form className="my-28">
                <h2 className="bg-red-700">Register Here</h2>
                <div className="grid gap-6 mb-6 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" id="last_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="(+880) xxxxxxxxx" required />
                    </div>
                ...
                <div className="flex items-start mb-6">
                    ...
                    <Link to="/SignIn" className="text-blue-600 hover:underline dark:text-blue-500 ml-2">Sign in here</Link></label>
                </div>
